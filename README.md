*CV template adapted from [S. Miller](https://github.com/svmiller/svm-r-markdown-templates)* [PDF version of extended CV
...
1.  **Burnett, J.L.**.*under review at Journal of Open Source Software*
    `bbsAssistant`. 2019. An R package for downloading and manipulating
    the North American Breeding Bird Survey data.
