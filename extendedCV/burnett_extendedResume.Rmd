...
- Assisted with creation of two R packages:
    ...
    - [`TVdiff`](https://github.com/natbprice/tvdiff): An R wrapper for 'TVDiff' Python code. Package implements numerical differentiation of noisy, non-smoothdata
...
1. Price, N.B. and **J.L. Burnett**. `tvdiff`. 2019.  An R package for numerical differentiation of noisy, nonsmooth data. [Github:natbprice/tvdiff](https://github.com/natbprice/tvdiff)
