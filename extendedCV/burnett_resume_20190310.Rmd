...
- Created statistical software for calculating various 'regime' detection metrics on ecological data (see GitHub: [`regimeDetectionMethods`](http://github.com/trashbirdecology/regimeDetectionMethods), [`bbsRDM`](http://github.com/trashbirdecology/bbsRDM)
