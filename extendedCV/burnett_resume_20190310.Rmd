...
- Created statistical software for calculating various 'regime' detection metrics on ecological data (see GitHub: [`regimeDetectionMethods`](http://github.com/trashbirdecology/bbsRDM), [`bbsRDM`](http://github.com/trashbirdecology/regimeD
