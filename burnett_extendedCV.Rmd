...
<!-- # Peer-reviewed Software Papers -->
# Software
## Author and maintainer
1. **Burnett, J.L.**. *in development* `bbsAssistant`. An R package for downloading and manipulating the North American Breeding Bird Survey data. [Github:trashbirdecology/bbsAssistant](https://github.com/TrashBirdEcology/bbsAssistant)
